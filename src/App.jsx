...
function App() {
  ...
  const copyPasswordToClipboard=useCallback(()=>{passwordRef.current?.select()},[password])
  return (
    <>
    
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-800 bg-gray-400">
